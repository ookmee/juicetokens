 ...
 */
export declare enum TimeSourceType {
    SYSTEM = "SYSTEM",
    NTP = "NTP",
    GNSS = "GNSS",
    RADIO = "RADIO",
 ...
 */
export declare enum SpoofingSignatureType {
    JUMP = "JUMP",
    DRIFT = "DRIFT",
...
export interface ITimeSynchronizer {
     ...
     */
    synchronizeTime(preferredSources: TimeSourceType[], includeProof: boolean): Promise<TimeSyncResult>;
}
/**
