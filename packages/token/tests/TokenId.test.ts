...
describe('TokenId', () => {
  describe('constructor', () => {
    it('should create a TokenId with the provided properties', () => {
      ...
      const tokenId = new TokenId(props);
  ...
  describe('generate', () => {
    it('should generate a TokenId with the provided issuanceId and sequenceNumber', () => {
      ...
      const tokenId = TokenId.generate(issuanceId, sequenceNumber);
  ...
  describe('validate', () => {
    it('should return true for a valid TokenId', () => {
      const tokenId = TokenId.generate('AMS-001', 42);
  ...
  describe('toJSON / fromJSON', () => {
    it('should correctly serialize and deserialize a TokenId', () => {
      const original = TokenId.generate('AMS-001', 42);
      const json = original.toJSON();
      const deserialized = TokenId.fromJSON(json);
