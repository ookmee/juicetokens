 ...
 */
export class WisselToken {
  private readonly _baseToken: Token;
  private _afrondingsbuffer: number;
  private _lastUpdatedTimeMs: number;
  private _lastTransactionId?: string;

  constructor(props: WisselTokenProps) {
    this._baseToken = props.baseToken instanceof Token 
      ? props.baseToken 
      : Token.fromJSON(props.baseToken);
