...
exports.TokenSerializer = void 0;
const TokenId_1 = require("../models/TokenId");
const Token_1 = require("../models/Token");
const WisselToken_1 = require("../models/WisselToken");
const Telomeer_1 = require("../models/Telomeer");
...
class TokenSerializer {
     ...
     */
    static mapDenominationToProto(denomination) {
        switch (denomination) {
     ...
     */
    static mapTokenStatusToProto(status) {
        switch (status) {
            case Token_1.TokenStatus.ACTIVE: return tokenModel.TokenState.ACTIVE;
            case Token_1.TokenStatus.RESERVED: return tokenModel.TokenState.PENDING;
            case Token_1.TokenStatus.EXPIRED: return tokenModel.TokenState.EXPIRED;
            case Token_1.TokenStatus.REVOKED: return tokenModel.TokenState.REVOKED;
            case Token_1.TokenStatus.CONSUMED: return tokenModel.TokenState.MERGED;
     ...
     */
    static mapDenominationFromProto(denomination) {
        switch (denomination) {
            case tokenModel.DenominationValue.DENOMINATION_1: return 1;
            case tokenModel.DenominationValue.DENOMINATION_2: return 2;
            case tokenModel.DenominationValue.DENOMINATION_5: return 5;
            case tokenModel.DenominationValue.DENOMINATION_10: return 10;
            case tokenModel.DenominationValue.DENOMINATION_20: return 20;
            case tokenModel.DenominationValue.DENOMINATION_50: return 50;
            case tokenModel.DenominationValue.DENOMINATION_100: return 100;
            case tokenModel.DenominationValue.DENOMINATION_200: return 200;
            case tokenModel.DenominationValue.DENOMINATION_500: return 500;
            default: return 1;
        }
    }
    /**
     ...
     */
    static mapTokenStatusFromProto(status) {
        switch (status) {
            case tokenModel.TokenState.ACTIVE: return Token_1.TokenStatus.ACTIVE;
            case tokenModel.TokenState.PENDING: return Token_1.TokenStatus.RESERVED;
            case tokenModel.TokenState.EXPIRED: return Token_1.TokenStatus.EXPIRED;
            case tokenModel.TokenState.REVOKED: return Token_1.TokenStatus.REVOKED;
            case tokenModel.TokenState.MERGED: return Token_1.TokenStatus.CONSUMED;
            default: return Token_1.TokenStatus.ACTIVE;
        }
    }
    /**
     * Convert a WisselToken to binary data using Protocol Buffers
     */
    static wisselTokenToBinary(wisselToken) {
        try {
            // This is a placeholder for the real Protocol Buffer implementation
            // When properly integrated with protobuf, uncomment the real implementation
            /*
     ...
     */
    static wisselTokenFromBinary(buffer) {
        try {
            // This is a placeholder for the real Protocol Buffer implementation
            // When properly integrated with protobuf, uncomment the real implementation
            /*
     ...
     */
    static telomeerToBinary(telomeer) {
        try {
            // This is a placeholder for the real Protocol Buffer implementation
            // When properly integrated with protobuf, uncomment the real implementation
            /*
     ...
     */
    static telomeerFromBinary(buffer) {
        try {
            // This is a placeholder for the real Protocol Buffer implementation
            // When properly integrated with protobuf, uncomment the real implementation
            /*
...
exports.TokenSerializer = TokenSerializer;
