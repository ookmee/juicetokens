...
exports.RoutingTableFactory = exports.DistanceVectorRoutingTable = void 0;
const rxjs_1 = require("rxjs");
/**
 * Implementation of a distance vector routing table
 */
class DistanceVectorRoutingTable {
    constructor(localAddress, config) {
        this.routes = new Map();
        this.cleanupTimer = null;
        this.routeUpdates = new rxjs_1.Subject();
        const defaultConfig = {
...
exports.DistanceVectorRoutingTable = DistanceVectorRoutingTable;
/**
 * Factory for creating routing table instances
 */
class RoutingTableFactory {
    static createDistanceVectorRoutingTable(localAddress, config) {
        return new DistanceVectorRoutingTable(localAddress, config);
    }
}
exports.RoutingTableFactory = RoutingTableFactory;
