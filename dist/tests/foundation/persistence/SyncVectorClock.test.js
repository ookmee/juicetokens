...
describe('SyncVectorClock', () => {
    ...
    test('should initialize with custom timestamp', () => {
        ...
        const clock = new SyncVectorClock_1.SyncVectorClock('node-1', timestamp);
    ...
    test('should merge with another clock', () => {
        const clock1 = new SyncVectorClock_1.SyncVectorClock('node-1');
        clock1.updateClockValue('node-1', 5);
        clock1.updateClockValue('node-2', 10);
        const clock2 = new SyncVectorClock_1.SyncVectorClock('node-2');
    ...
    test('should serialize and deserialize', () => {
        const originalClock = new SyncVectorClock_1.SyncVectorClock('node-1');
        ...
        const deserializedClock = SyncVectorClock_1.SyncVectorClock.deserialize(serialized);
        expect(deserializedClock).toBeInstanceOf(SyncVectorClock_1.SyncVectorClock);
    ...
    test('should create from proto format', () => {
        ...
        clock.updateClockValue('node-2', 10);
        const proto = clock.toProto();
        const fromProto = SyncVectorClock_1.SyncVectorClock.fromProto(proto);
...
//# sourceMappingURL=SyncVectorClock.test.js.map