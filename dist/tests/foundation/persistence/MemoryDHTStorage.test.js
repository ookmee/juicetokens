...
const MemoryDHTStorage_1 = require("../../../src/foundation/persistence/adapters/MemoryDHTStorage");
const persistence_1 = require("../../../src/generated/foundation/persistence");
describe('MemoryDHTStorage', () => {
    let storage;
    // Sample DHT entry for testing
    const createTestEntry = (id) => {
        return persistence_1.DHTEntry.create({
    ...
    beforeEach(async () => {
        storage = new MemoryDHTStorage_1.MemoryDHTStorage();
...
//# sourceMappingURL=MemoryDHTStorage.test.js.map