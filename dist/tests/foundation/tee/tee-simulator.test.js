...
describe('TEE Simulator', () => {
    ...
    beforeEach(() => {
        ...
        teeSimulator = new foundation_1.TeeSimulator(mockLogger, {
    ...
    test('Should handle attestation failure', async () => {
        ...
        const failingSimulator = new foundation_1.TeeSimulator(mockLogger, {
            simulateDelays: false,
    ...
    test('Should reject unknown functions', async () => {
        await expect(teeSimulator.executeSecureFunction('unknownFunction', [])).rejects.toThrow();
    });
    test('Should allow configuring function results', async () => {
        ...
        teeSimulator.setFunctionResult('add', (a, b) => a + b);
...
//# sourceMappingURL=tee-simulator.test.js.map