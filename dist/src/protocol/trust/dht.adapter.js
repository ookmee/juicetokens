...
class DHTAdapter {
    constructor() {
        ...
        this.localDHTStore = new Map();
        this.geospatialShards = new Map();
    }
    /**
     * Publishes an attestation to the DHT
     */
    publishAttestation(wrapper, options) {
     ...
     */
    queryAttestations(query, options = {}) {
        const results = [];
        let totalResults = 0;
     ...
     */
    queryAttestationsByGeospatialShard(s2CellId, query, options) {
     ...
     */
    publishReputationData(userId, reputationData, options) {
     ...
     */
    publishIdentityData(identityId, identityData, didDocument, options) {
     ...
     */
    privacyPreservingLookup(lookup) {
     ...
     */
    addToGeospatialShard(dhtKey, s2CellId, wrapper) {
     ...
     */
    generateReputationDHTKey(userId) {
        const hash = (0, crypto_1.createHash)('sha256');
     ...
     */
    generateIdentityDHTKey(identityId) {
        const hash = (0, crypto_1.createHash)('sha256');
     ...
     */
    generateContinuationToken(results) {
        if (results.length === 0) {
            return '';
        }
     ...
     */
    calculateMerkleRoot(attestationIds) {
     ...
     */
    matchesAttestationQuery(wrapper, query) {
        const attestation = wrapper.attestation;
...
exports.DHTAdapter = DHTAdapter;
//# sourceMappingURL=dht.adapter.js.map