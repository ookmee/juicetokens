...
describe('DevelopmentalStageAdapter', () => {
    ...
    beforeEach(() => {
        adapter = new DevelopmentalStageAdapter_1.DevelopmentalStageAdapter();
    });
    describe('initializeUserStage', () => {
        it('should initialize a new user with TRUST as the starting stage', () => {
            ...
            expect(userStatus.currentPrimaryStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.TRUST);
            expect(userStatus.currentSecondaryStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.TRUST);
            expect(userStatus.stageHistory).toHaveLength(0);
            const trustMetric = userStatus.stageMetrics.get(developmental_stage_types_1.DevelopmentalStageLevel.TRUST.toString());
    ...
    describe('recordActivityCompletion', () => {
        it('should update user metrics when an activity is completed', () => {
            ...
            const trustMetric = updatedStatus.stageMetrics.get(developmental_stage_types_1.DevelopmentalStageLevel.TRUST.toString());
            expect(trustMetric).toBeDefined();
            ...
            const autonomyMetric = updatedStatus.stageMetrics.get(developmental_stage_types_1.DevelopmentalStageLevel.AUTONOMY.toString());
    ...
    describe('transitionStage', () => {
        it('should transition user to the next stage', () => {
            ...
            const transitionResult = adapter.transitionStage(userStatus, developmental_stage_types_1.DevelopmentalStageLevel.AUTONOMY, 'test_transition', ['witness-1']);
            expect(transitionResult.success).toBe(true);
            expect(transitionResult.data).toBeDefined();
            const updatedStatus = transitionResult.data;
            // Check updated stage
            expect(updatedStatus.currentPrimaryStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.AUTONOMY);
            expect(updatedStatus.currentSecondaryStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.TRUST);
            ...
            expect(transition.fromStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.TRUST);
            expect(transition.toStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.AUTONOMY);
        ...
        it('should not allow skipping stages', () => {
            ...
            const transitionResult = adapter.transitionStage(userStatus, developmental_stage_types_1.DevelopmentalStageLevel.IMAGINATION);
    ...
    describe('Stage progression through multiple activities', () => {
        it('should progress through stages with enough activities', () => {
            ...
            const createActivity = (id, name, stage) => ({
                activityId: id,
                activityName: name,
            ...
            const trustActivity = createActivity('trust-1', 'Trust Building', developmental_stage_types_1.DevelopmentalStageLevel.TRUST);
            const autonomyActivity = createActivity('autonomy-1', 'Autonomy Development', developmental_stage_types_1.DevelopmentalStageLevel.AUTONOMY);
            const imaginationActivity = createActivity('imagination-1', 'Imagination Exploration', developmental_stage_types_1.DevelopmentalStageLevel.IMAGINATION);
            ...
            expect(userStatus.currentPrimaryStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.AUTONOMY);
            ...
            expect(userStatus.currentPrimaryStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.IMAGINATION);
            // Verify stage history has two transitions
            expect(userStatus.stageHistory).toHaveLength(2);
            expect(userStatus.stageHistory[0].fromStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.TRUST);
            expect(userStatus.stageHistory[0].toStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.AUTONOMY);
            expect(userStatus.stageHistory[1].fromStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.AUTONOMY);
            expect(userStatus.stageHistory[1].toStage).toBe(developmental_stage_types_1.DevelopmentalStageLevel.IMAGINATION);
        });
    });
        ...
        it('should recommend relevant activities for the current stage', () => {
            ...
            const activities = [
                ...
                },
                {
                    ...
                    primaryStage: developmental_stage_types_1.DevelopmentalStageLevel.AUTONOMY,
                    secondaryStages: [developmental_stage_types_1.DevelopmentalStageLevel.TRUST],
            ...
            const recommendationsResult = adapter.generateProgressionRecommendations(userStatus, activities, ['user-1', 'user-2', 'user-3', 'user-4']);
...
//# sourceMappingURL=DevelopmentalStageAdapter.test.js.map